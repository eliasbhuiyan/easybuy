...
const Breadcrumd = ({ space }) => {
  ...
  return (
    <div className="my-12 md:my-32">
      <h2 className="mb-3 font-dm font-bold text-5xl text-primary capitalize">
        {space ? padMiddle : name}
      </h2>
      <p className="flex items-center font-dm font-norma text-xl text-secondary capitalize">
