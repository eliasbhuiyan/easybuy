...
export const CartNav = () => {
  ...
  return (
   <>
     <summary className={`relative after:absolute after:content-['${cartProduct.length}'] after:text-center after:bottom-5 after:text-white after:leading-[20px] after:w-5 after:h-5 after:bg-green-500 after:rounded-full`}>
    ...
    <div className="absolute top-full right-0 shadow-xl md:w-[400px] w-60">
      ...
      <div key={item._id} className="flex items-center flex-wrap justify-between md:p-5 p-3 bg-bg">
        ...
        : <p className="flex items-center justify-center md:p-5 p-3 bg-bg text-primary font-semibold text-xl">{cartProduct.message}</p>
      }
      {
         cartProduct.length > 0
         &&
